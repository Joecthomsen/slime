...
HD_PWD='C:/Git/slime/hdmi-out.runs/hdmi_out_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_out_axi_gpio_0_1.tcl
