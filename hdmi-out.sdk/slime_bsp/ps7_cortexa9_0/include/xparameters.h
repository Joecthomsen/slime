...
/* Definitions for peripheral AXI_GPIO_CONTROLLER_1 */
#define XPAR_AXI_GPIO_CONTROLLER_1_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_CONTROLLER_1_HIGHADDR 0x4124FFFF
#define XPAR_AXI_GPIO_CONTROLLER_1_DEVICE_ID 2
#define XPAR_AXI_GPIO_CONTROLLER_1_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CONTROLLER_1_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_CONTROLLER_2 */
#define XPAR_AXI_GPIO_CONTROLLER_2_BASEADDR 0x41250000
#define XPAR_AXI_GPIO_CONTROLLER_2_HIGHADDR 0x4125FFFF
#define XPAR_AXI_GPIO_CONTROLLER_2_DEVICE_ID 3
#define XPAR_AXI_GPIO_CONTROLLER_2_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CONTROLLER_2_IS_DUAL 0
...
/* Canonical definitions for peripheral AXI_GPIO_CONTROLLER_1 */
#define XPAR_GPIO_2_BASEADDR 0x41240000
#define XPAR_GPIO_2_HIGHADDR 0x4124FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_CONTROLLER_1_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_CONTROLLER_2 */
#define XPAR_GPIO_3_BASEADDR 0x41250000
#define XPAR_GPIO_3_HIGHADDR 0x4125FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_CONTROLLER_2_DEVICE_ID
